	...
	insertNewExpense(e) {
		...
		axios.post('/insert',
			querystring.stringify({
				description: e.state.description? e.state.description: '',
				amount: e.state.amount? e.state.amount: '',
				month: e.state.month,
				year: e.state.year
			})
		)
			...
			return (
				<div>
					...
					<Modal isOpen={this.state.modalIsOpen}
						...
						<br/>
						<fieldset>
							<label>Description:</label><input type="text" id="description" name="description" value={this.state.description} onChange={this.handleTextChange}></input>
							<label>Amount:</label><input type="number" id="amount" name="amount" value={this.state.amount} onChange={this.handleTextChange}></input>
							<label>Month:</label>
